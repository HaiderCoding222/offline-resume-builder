...
(function () {
    ...
    function renderEditorPanel() {
        ...
        templateState.sections.forEach((sec, idx) => {
                    ...
                    itemsHTML += `
                        <div style="border:1px dashed #cbd5e1; padding:6px; margin-bottom:6px; border-radius:4px; background:#fff;">
                            <div style="display:flex; justify-content:space-between; margin-bottom:4px;">
                                ...
                                <div>
                                    <button onclick="window.tmplCloneItem('experience', ${i})" style="padding:1px 4px; font-size:10px; cursor:pointer;" title="Clone Experience">📋 Clone Item</button>
                            ...
                            <input type="text" value="${exp.duration || ''}" placeholder="Duration (e.g. 2022 - Present)" oninput="window.tmplUpdateItem('experience', ${i}, 'duration', this.value)" style="width:100%; font-size:11px; padding:3px; margin-bottom:3px;">
                    ...
                    itemsHTML += `
                        <div style="border:1px dashed #cbd5e1; padding:6px; margin-bottom:6px; border-radius:4px; background:#fff;">
                            <div style="display:flex; justify-content:space-between; margin-bottom:4px;">
                                ...
                                <div>
                                    <button onclick="window.tmplCloneItem('education', ${i})" style="padding:1px 4px; font-size:10px; cursor:pointer;" title="Clone Education">📋 Clone Item</button>
                            ...
                            <input type="text" value="${edu.institute || ''}" placeholder="Institute / University" oninput="window.tmplUpdateItem('education', ${i}, 'institute', this.value)" style="width:100%; font-size:11px; padding:3px; margin-bottom:3px;">
                            <input type="text" value="${edu.degree || ''}" placeholder="Degree / Certificate" oninput="window.tmplUpdateItem('education', ${i}, 'degree', this.value)" style="width:100%; font-size:11px; padding:3px; margin-bottom:3px;">
                            <input type="text" value="${edu.year || ''}" placeholder="Year (e.g. 2020 - 2022)" oninput="window.tmplUpdateItem('education', ${i}, 'year', this.value)" style="width:100%; font-size:11px; padding:3px;">
                        </div>
                    `;
                });
            ...
            // SECTION HEADER WITH COMPLETE SECTION CLONE + DELETE CONTROLS
            secCard.innerHTML = `
    ...
    // --- SCOPED ACTIONS FOR WHOLE SECTIONS --- //
    ...
    window.tmplAddItem = function(key) {
        if (key === 'skills') {
            ...
            templateState.experience.push({ company: "New Company", role: "Job Title", duration: "2026 - Present", details: "• Job responsibilities..." });
 ...
 // Auto Init & Attach Download Listener
    setTimeout(() => {
        ...
        const downloadBtn = document.getElementById("btn-download-pdf");
        if (downloadBtn) {
            // 1. Remove hidden class so button becomes visible on screen
            downloadBtn.classList.remove("hidden");
            downloadBtn.style.display = "inline-block"; // Extra check to ensure visibility

            // 2. Attach PDF Download Listener cleanly
