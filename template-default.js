// ====================================================
// TEMPLATE DEFAULT - FULLY MOBILE RESPONSIVE
// ====================================================
...
(function () {
    ...
    // Mobile Tab Switching with CSS Classes
    ...
    window.renderDefaultTemplate = function () {
        ...
        // Mobile: Default to Editor tab on small screens
        if (window.innerWidth <= 820) {
    ...
    // Handle resize for mobile tab state
    window.addEventListener('resize', () => {
        ...
        if (window.innerWidth > 820) {
            ...
            if (!editorPane?.classList.contains('mobile-hidden') && !previewPane?.classList.contains('mobile-hidden')) {
                // Default to editor if both visible
                window.tmplSwitchTab('editor');
            }
        }
    });
