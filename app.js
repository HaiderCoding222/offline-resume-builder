    ...
    const opt = {
        ...
        html2canvas: { 
            ...
            onclone: function(clonedDoc) {
                const clonedEl = clonedDoc.querySelector('.cv-premium-container') || 
                                 clonedDoc.querySelector('.cv-ats-theme') || 
                                 clonedDoc.querySelector('.cv-blue-container');
                if (clonedEl) {
                    // Force exact A4 width on clone - no matter what device
                    clonedEl.style.width = '794px';
                    clonedEl.style.maxWidth = '794px';
                    clonedEl.style.minWidth = '794px';
                    // Remove any mobile transforms that break rendering
                ...
                // Fix cloned document body width
