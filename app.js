...
btnDownloadPDF.addEventListener('click', async () => {
    ...
    // Mobile detect karo - scale kam rakho mobile pe
    ...
    const opt = {
        ...
        html2canvas: { 
            ...
            width: 794,
            windowWidth: 794,
            // YEH MAGIC HAI - onclone se mobile issue fix hota hai
            onclone: function(clonedDoc) {
                const clonedEl = clonedDoc.querySelector('.cv-teal-container') || 
                                clonedDoc.querySelector('.cv-premium-container') || 
                                clonedDoc.querySelector('.cv-ats-theme') || 
                                clonedDoc.querySelector('.cv-blue-container');
                                
                if (clonedEl) {
                    // Force exact width for PDF
                    clonedEl.style.width = '1100px';
                    clonedEl.style.maxWidth = '1100px';
                    clonedEl.style.minWidth = '1100px';
                    
                    // Extra safety for PDF rendering
