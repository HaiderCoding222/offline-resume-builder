...
btnDownloadPDF.addEventListener('click', async () => {
    ...
    const opt = {
        ...
        html2canvas: { 
            ...
            width: 1100,
            windowWidth: 1100,
            height: cvElement.scrollHeight,  // ✅ IMPORTANT: Full height capture
            onclone: function(clonedDoc) {
                const el = clonedDoc.querySelector('.cv-teal-container');
                if (el) {
        ...
        jsPDF: { 
            unit: 'px', 
            format: [1100, 1550],  // ✅ Increased height for more content
