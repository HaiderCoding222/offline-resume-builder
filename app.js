const state = {
    ...
    resumeData: {
        name: "Ansar Abbas",
        title: "Senior Web Develooper",
        email: "lak355603@gmail.com",
        phone: "+92 348 7714438",
        summary: "Experienced Senior Web Developer with expertise in web development, programming, and software engineering. Skilled in creating responsive and user-friendly websites and applications.",
        photo: ""
    },
    education: [
        { id: "ed1", degree: "Bachelors of Commerce", institute: "Government College Sargodha", year: "2020 - 2022" },
        { id: "ed2", degree: "MSC It", institute: "University of Sargodha ", year: "2021 - 2023" }
    ],
    experience: [
        { 
            id: "ex1", 
        ...
        { 
            ...
            company: "Code and Bytes Pvt Ltd.", 
            duration: "06/08/2026 - 06/08/2026",
...
async function loadActiveTemplate() {
    ...
    try {
        ...
        // Add wrapper for better preview control
...
// ================== DOWNLOAD PDF - IMPROVED FOR MOBILE ==================
...
btnDownloadPDF.addEventListener('click', async () => {
    ...
    const opt = {
        ...
        pagebreak: { 
            mode: ['avoid-all', 'css'],
            avoid: ['.cv-experience-node', '.sidebar-section']
        }
    };
